...
export default function MemoryPolaroidItem2({ data }: MemoryPolaroidItemProps) {
  return (
    <div className='w-[320px] h-[528px] flex flex-col gap-1 items-center py-4 px-4'>
      {/* 사진 영역 */}
      <div className='w-[288px] h-[444px] flex flex-col gap-4'>
        <div className='w-[288px] h-[360px] bg-[#eeeeee]'></div>
