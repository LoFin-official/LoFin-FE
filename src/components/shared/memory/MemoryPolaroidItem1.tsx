...
export default function MemoryPolaroidItem1({ data }: MemoryPolaroidItemProps) {
  return (
    <div className='w-[280px] h-[610px] flex flex-col gap-1 items-center py-4 px-4'>
      {/* 사진 영역 */}
      <div className='w-[248px] h-[526px] flex flex-col gap-4'>
        <div className='w-[248px] h-[442px] bg-[#eeeeee]'></div>
