...
export default function MemoryPolaroidItem1({ data, defaultX = 0, defaultY = 0, defaultRotation = 0 }: MemoryPolaroidItemProps) {
  return (
    <DraggablePolaroid defaultX={defaultX} defaultY={defaultY} defaultRotation={defaultRotation} width={280} height={490}>
      <div className='w-[280px] h-[490px] flex flex-col gap-1 items-center py-4 px-4 bg-white'>
        {/* 사진 영역 */}
        <div className='w-[248px] h-[414px] flex flex-col gap-4'>
          <div className='w-[248px] h-[330px] bg-[#eeeeee]'>
