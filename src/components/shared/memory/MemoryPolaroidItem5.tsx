...
export default function MemoryPolaroidItem5({ data }: MemoryPolaroidItemProps) {
  return (
    <div className='w-[380px] h-[430px] flex flex-col gap-1 items-center py-4 px-4'>
      {/* 사진 영역 */}
      <div className='w-[348px] h-[346px] flex flex-col gap-4'>
        <div className='w-[348px] h-[262px] bg-[#eeeeee]'></div>
