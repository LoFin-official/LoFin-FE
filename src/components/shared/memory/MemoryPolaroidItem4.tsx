...
export default function MemoryPolaroidItem4({ data, defaultX = 0, defaultY = 0, defaultRotation = 0 }: MemoryPolaroidItemProps) {
  return (
    <DraggablePolaroid defaultX={defaultX} defaultY={defaultY} defaultRotation={defaultRotation} width={380} height={468}>
      <div className='w-[380px] h-[468px] flex flex-col gap-1 items-center py-4 px-4 bg-white'>
        {/* 사진 영역 */}
        <div className='w-[348px] h-[384px] flex flex-col gap-4'>
          <div className='w-[348px] h-[300px] bg-[#eeeeee]'>
