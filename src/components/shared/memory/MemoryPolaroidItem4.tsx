...
export default function MemoryPolaroidItem4({ data }: MemoryPolaroidItemProps) {
  return (
    <div className='w-[380px] h-[468px] flex flex-col gap-1 items-center py-4 px-4'>
      {/* 사진 영역 */}
      <div className='w-[348px] h-[384px] flex flex-col gap-4'>
        <div className='w-[348px] h-[300px] bg-[#eeeeee]'></div>
