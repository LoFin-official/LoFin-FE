...
export default function MemoryPolaroidItem3({ data, defaultX = 0, defaultY = 0, defaultRotation = 0 }: MemoryPolaroidItemProps) {
  return (
    <DraggablePolaroid defaultX={defaultX} defaultY={defaultY} defaultRotation={defaultRotation} width={332} height={468}>
      <div className='w-[332px] h-[468px] flex flex-col gap-1 items-center py-4 px-4 bg-white'>
        {/* 사진 영역 */}
        <div className='w-[300px] h-[384px] flex flex-col gap-4'>
          <div className='w-[300px] h-[300px] bg-[#eeeeee]'>
